...
const Footer = () => {
  return (
    <footer>
      ...
      <div
        className="grid grid-cols-3 items-center bg-[#fdf7f3] py-8 px-2"
      ...
      {/* Main Footer Content */}
      <div className="grid grid-cols-12 gap-4 bg-[#fdf7f3] py-8 px-4" style={{ fontFamily: "Jomolhari" }}>
        {/* About Us Section */}
      ...
      {/* Copyright Section */}
      <div className="bg-[#fdf7f3] py-4 border-t-2 border-[#9e645b]">
